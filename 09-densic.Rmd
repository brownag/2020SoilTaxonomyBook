# Proposed Revisions of C and R Master Horizons, r and d horizon suffixes, and Densic, Paralithic, and Lithic Materials/Contacts

[(2/18/20; PDF; 143 KB)](https://www.nrcs.usda.gov/wps/PA_NRCSConsumption/download?cid=nrcseprd1543820&ext=pdf)
...
A root-limiting layer defines the bottom of the soil horizons considered for most, but not all, differentiae at the family level (Keys to Soil Taxonomy, 12th edition, p. 319). The upper boundary of a root-limiting layer coincides with the upper boundary of the following diagnostic features: 

 - Duripan and Fragipan
 
 - Petrocalcic, Petrogypsic, and Placic Horizons
...
Cd over Cr to portray noncemented bedrock over paralithic bedrock is technically a legitimate option I could use to portray a gradient in bedrock weathering. Likewise, I could in theory use it for dense till over bedrock – with or without densic or paralithic _contacts_. Those two cases would be distinguished by parent material -- and taxonomically they could be identical if those parent materials did not result in meaningful differences in the taxonomic relevant quantities.
...
An explanation why I don’t use it is based on the rocks commonly found in my area – which are highly fractured – significantly influencing weathering patterns and potential pedogenesis. If a layer containing non-cemented bedrock is so weathered that it no longer reflects original volumetric relationships in the parent rock (i.e. the visible rock fabric has become “denser,” or large portions have been altered/removed, but elements of it are still present) it has generally weathered enough,  to be considered a soil material (rather than parent material) in the profile proper. It may locally contain significant amounts of pararock fragments, but it is too pedogenically altered and too penetrable by roots to be densic or paralithic materials per their definitions.
